        ...
        <div class="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
          <div class="pt-32 sm:pt-0">
            <h2 class="font-semibold text-4xl text-blueGray-600">
              Vue Notus - A beautiful extension for Tailwind CSS. testtest2223355566
            </h2>
...
import patternVue from "@/static/img/pattern_vue.png";
import componentBtn from "@/static/img/component-btn.png";
import componentProfileCard from "@/static/img/component-profile-card.png";
import componentInfoCard from "@/static/img/component-info-card.png";
import componentInfo2 from "@/static/img/component-info-2.png";
import componentMenu from "@/static/img/component-menu.png";
import componentBtnPink from "@/static/img/component-btn-pink.png";
